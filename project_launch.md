...
&emsp;-sql: частина проєкту, що була виконана у базі PostgreSQL<br>
...
docker run -d --name postgres-expenses ^
           ...
           postgres:18.4
```
3.3 Перейти до завантаженої директорії 'personal_finance_analysis':
```
...
```
3.7 Скористатися автоматичною підготовкою середовища для виконання проєкту:
```
.\w_start.cmd
```
...
docker run -d --name postgres-expenses \
           ...
           postgres:18.4
```
5.3 Перейти до завантаженої директорії 'personal_finance_analysis':
```
cd ~/шлях/до/personal_finance_analysis
```
...
chmod +x m_start.sh
```
5.8 Скористатися автоматичною підготовкою середовища для виконання проєкту:
```
source m_start.sh
```
...
```
7.4 Перейти до завантаженої директорії 'personal_finance_analysis':
```
cd шлях/до/personal_finance_analysis
```
...
chmod +x l_start.sh
```
7.9 Скористатися автоматичною підготовкою середовища для виконання проєкту:
```
source l_start.sh
```
